    ...
    <div className={`relative ${className}`}>
      ...
      {isOpen && (
        <div className="absolute right-0 bottom-full mb-2 bg-white dark:bg-gray-800 
          rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-2">
          ...
          <div className="flex flex-col">
            {shareLinks.map(link => (
              <a
                ...
                className="flex items-center px-4 py-2 space-x-3 hover:bg-gray-100 
              ...
              >
                ...
                <span className="text-sm text-gray-700 dark:text-gray-200">{link.name}</span>
              </a>
            ))}
          </div>
        </div>
